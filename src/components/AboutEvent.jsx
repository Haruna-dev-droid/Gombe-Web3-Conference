...
function AboutEvent() {
  return (
    <div className=" border-t border-black p-20 bg-red-950 ">
      ...
      <div className=" flex flex-col flex-wrap md:flex-row mt-10 md:mt-20 justify-center space-y-10 md:space-y-0 md:space-x-15 text-black">
        ...
        <div className="mt-2 text-white">
          ...
          <p className="text-md md:text-left text-center  mt-4">
            ...
            bridging healthcare and Web3 through education, preventive medicine,
            public health education on the blockchain. The conference will
            emphasize practical applications of Web3 across sectors like
            healthcare, startups, and social impact. The conference will be a
            yearly event which will be advocating for the adoption of Web3 in
            the African ecosystem. The second edition will highlight the
            evolution of Web3 adoption in underrepresented regions which the
            northeast Nigeria region is one of them.
          </p>
