    ...
    >
      <section className="py-16 bg-gray-50" id="speakers">
        ...
        <div className="mt-10 text-center">
          <h3 className="text-4xl md:text-6xl font-bold text-red-800 mb-6">
            Event Host
          </h3>
          <div className="bg-white inline-block rounded-2xl shadow-md p-8 max-w-60 md:max-w-sm">
            <img
              src={host.image}
              alt={host.name}
              className="md:w-70 md:h-70 w-40 h-40 rounded-full object-cover mx-auto mb-4 border-4 border-gray-200"
            />
        ...
        <div className="text-center mt-15 mb-10">
          <h2 className="text-4xl md:text-6xl font-bold text-red-800">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 max-w-2xl md:max-w-6xl mx-auto px-4">
          {speakers.map((speaker, index) => (
            ...
            >
              ...
              <p className="text-gray-500 text-semibold text-sm mb-2">
                {speaker.title}
              </p>
              {speaker.profile && (
                <div className="text-gray-800 text-semibold text-sm text-center">
                  <p>
