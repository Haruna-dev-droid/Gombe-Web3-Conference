...
function CommunityPartners() {
  return (
    <div className="text-red-700 bg-white p-20">
      <h1 className="text-4xl md:text-6xl font-bold md:text-left text-center">
        Community Partners
      </h1>
      <div className="flex flex-wrap gap-15 md:gap-20 justify-center mt-10">
        ...
        <img
          ...
          className="md:w-40 w-32"
        />
        <img src={BORDERLESS} alt="Borderless Logo" className="md:w-40 w-32" />
